...
describe('Contract', () => {
    ...
    before(() => {
        Math = Contract.fromEthersContract(new ethers.Contract(SAMPLE_ADDRESS, mathABI.abi));
    });
...
describe('Planner', () => {
    ...
    before(() => {
        Math = Contract.fromEthersContract(new ethers.Contract(SAMPLE_ADDRESS, mathABI.abi));
        Strings = Contract.fromEthersContract(new ethers.Contract(SAMPLE_ADDRESS, stringsABI.abi));
    });
    ...
    it('plans a simple program', () => {
        ...
        expect(commands[0]).to.equal("0x771602f70001ffffffffffffeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee");
    ...
    it('plans a program that uses return values', () => {
        ...
        expect(commands[0]).to.equal("0x771602f70001ffffffffff00eeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee");
        expect(commands[1]).to.equal("0x771602f70002ffffffffffffeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee");
    ...
    it('plans a program that needs extra state slots for intermediate values', () => {
        ...
        expect(commands.length).to.equal(2);
        expect(commands[0]).to.equal("0x771602f70000ffffffffff01eeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee");
        expect(commands[1]).to.equal("0x771602f70001ffffffffffffeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee");
    ...
    it('plans a program that takes dynamic arguments', () => {
        ...
        expect(commands.length).to.equal(1);
        expect(commands[0]).to.equal("0x367bbd7880ffffffffffffffeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee");
    ...
    it('plans a program that returns dynamic arguments', () => {
        ...
        expect(commands.length).to.equal(1);
        expect(commands[0]).to.equal("0xd824ccf38081ffffffffffffeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee");
    ...
    it('plans a program that takes a dynamic argument from a return value', () => {
        ...
        expect(commands.length).to.equal(2);
        expect(commands[0]).to.equal("0xd824ccf38081ffffffffff80eeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee");
        expect(commands[1]).to.equal("0x367bbd7880ffffffffffffffeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee");
