...
describe('Planner', () => {
  ...
  it('plans CALLs', () => {
    let Math = Contract.createContract(new ethers.Contract(SAMPLE_ADDRESS, mathABI.abi))
  ...
  it('plans STATICCALLs', () => {
    let Math = Contract.createContract(new ethers.Contract(SAMPLE_ADDRESS, mathABI.abi), CommandFlags.STATICCALL)
